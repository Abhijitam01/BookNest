        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="flex gap-6">
              ...
              <a href="https://github.com/aishasingh/kitaabghar" className="text-gray-400 hover:text-amber-400 transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.207 11.387.6.11.793-.26.793-.577v-2.234c-3.338.726-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.756-1.333-1.756-1.09-.744.083-.729.083-.729 1.205.084 1.84 1.237 1.84 1.237 1.07 1.835 2.807 1.305 3.492.998.108-.774.418-1.305.76-1.605-2.665-.305-5.467-1.333-5.467-5.93 0-1.31.467-2.382 1.237-3.222-.124-.303-.536-1.523.117-3.176 0 0 1.01-.323 3.31 1.23a11.52 11.52 0 013.017-.405c1.023.005 2.05.138 3.017.405 2.3-1.553 3.31-1.23 3.31-1.23.653 1.653.241 2.873.118 3.176.77.84 1.237 1.912 1.237 3.222 0 4.61-2.807 5.623-5.48 5.92.43.37.812 1.102.812 2.222v3.293c0 .32.192.694.8.577C20.565 21.8 24 17.3 24 12c0-6.63-5.37-12-12-12z" />
                </svg>
              </a>
            </div>
          </div>
